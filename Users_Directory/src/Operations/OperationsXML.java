...
public class OperationsXML {
    ...
    public boolean findInXMLByTag(String nameXML,String tagXML,String contentTag)throws Exception {
        ...
        org.w3c.dom.Document document = builder.parse(new File(nameXML));
        boolean flag=false;
    ...
    public File findUserInXML(String name, String email)throws Exception{
        File[] filesList;
        File foundXML=new File("notFound");
        File filesPath = new java.io.File("C:\\Users\\1231\\IdeaProjects\\Users_Directory\\");
        ...
        for(int i=0; i<filesList.length; i++) {
            ...
            if (buf.endsWith(".xml")){
                if((findInXMLByTag(buf,"name",name)&&(findInXMLByTag(buf,"email",email)))){
    ...
    public Document createDocumentXML(User user, String nameXML) {
        ...
        try {
            ...
            FileWriter fw = new FileWriter(nameXML+".xml");
